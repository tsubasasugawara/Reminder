  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        FutureBuilder(
          future: context.read(autoDeletionProvider.notifier).init(),
                ...
                children: [
                  Center(
                    child: CheckboxListTile(
                      value: ref.watch(autoDeletionProvider).checkBoxCondition,
                      title: Text(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ref.watch(autoDeletionProvider).controller.text == "1"
