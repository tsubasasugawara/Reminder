...
//             val NotificationsHelper = NotificationsHelper(context, NotificationsHelper.dbName, null, NotificationsHelper.version);
...
//             val num = db.insert(NotificationsHelper.dbName, null, values)
//             db.close()
//             return num
//         } catch (e: Exception) {
